...
// stops at 1608 only in the check  primes iteration, but this change should make it much faster
// implies to me k is invalid, but how?
// should check the count first maybe?
